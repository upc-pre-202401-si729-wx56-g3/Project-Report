...
|<div style="width:40px">Story ID</div>|Título|Descripción|<div style="width:300px">Criterio de aceptación</div>|<div style="width:30px">Epic ID</div>|
| :- | :- | :- | :- | :- |
|*Epic 1: Landing page<br>Como* empresario o freelancer<br>*Quiero* visualizar una página<br>*Para* saber acerca de la aplicación e ingresar a la aplicación||||a|
